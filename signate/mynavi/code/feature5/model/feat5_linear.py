...
def main(args):
    train=pd.read_feather('../data/train_feat5_scalling_robust.ftr')
    test=pd.read_feather('../data/test_feat5_scalling_robust.ftr')
    ...
    sub[1]=y_preds
    save_path='feat5_scalling_robust_default_params_{}_CV=={}'.format(args.model,cv.mean(axis=1)[0])
