...
def main():
    ...
    train=pd.read_feather('/Users/satsuki/kaggle/signate/mynavi/code/feature7/data/train_feat7_all.ftr')
    test=pd.read_feather('/Users/satsuki/kaggle/signate/mynavi/code/feature7/data/test_feat7_all.ftr')
...
if __name__=='__main__':
    ...
    # ログの保存先
    handler = FileHandler('feat6_lightgbm.py.log', 'a')
